...
namespace CSPSS.VOUCHER_MANAGE
{
    public partial class VOUCHER : Form
    {
        ...
        private void dgvStateControl()
        {
            ...
            dataGridView1.Columns["公司余额"].Width = 70;
            dataGridView1.Columns["是否打款"].Width = 70;
            ...
            dataGridView1.Columns["应付金额"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            dataGridView1.Columns["已付金额"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            dataGridView1.Columns["未付金额"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            int i;
 ...
 (SELECT USER_GROUP FROM USERINFO WHERE USID='"+LOGIN .USID +"'))"+sqlo );
            ...
            //MessageBox.Show(dt.Rows[0]["支出金额"].ToString());
